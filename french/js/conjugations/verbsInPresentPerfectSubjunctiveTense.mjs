...
export const audioFileFolder = 'present-perfect-subjunctive';
...
export default {
	...
	"Se dépêcher": {
		"que je": "me sois dépêché",
		"que tu": "te sois dépêché",
		"qu'il": "se soit dépêché",
		"que nous": "nous soyons dépêchés",
		"que vous": "vous soyez dépêchés",
	...
	"S’enrichir": {
		"que je": "me sois enrichi",
		"que tu": "te sois enrichi",
		"qu'il": "se soit enrichi",
		"que nous": "nous soyons enrichis",
		"que vous": "vous soyez enrichis",
